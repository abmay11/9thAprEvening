...
public class June28ArrayList {
	...
	{
		ArrayList al=new ArrayList(); //created object of ArrayList //heterogeneous type..thats y return type is object 
		...
		System.out.println(al.size()); //size=index+1
		System.out.println();
		...
		System.out.println(al.remove(0)); //index basis //remove from list and return that removed element in console
		System.out.println(al); //after removing 
		System.out.println();
		
		al.add(1, "Mumbai"); //cant use in println stmnt
		System.out.println(al);
		System.out.println();
		
		System.out.println(al.remove(99.99)); //element basis
		System.out.println(al);
		System.out.println("==============");
